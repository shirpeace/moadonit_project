        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#dropatten"><i class="fa fa-fw fa-check-square-o"></i> נוכחות <i class="fa fa-fw fa-chevron-down pull-left"></i></a>
                        <ul id="dropatten" class="collapse">
                            <li>
                                <a href="#">נוכחות מועדונית</a>
                            </li>
                            <li>
                                <a href="#">נוכחות חוגים</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#dropsettings"><i class="fa fa-fw fa-folder-open"></i> ניהול מערכת <i class="fa fa-fw fa-chevron-down pull-left"></i></a>
                        <ul id="dropsettings" class="collapse">
                            <li>
                                <a href="#">צוות המועדונית</a>
                            </li>
                            <li>
                                <a href="#">מתנדבים</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            כותרת ראשית <small>כותרת משנה</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
